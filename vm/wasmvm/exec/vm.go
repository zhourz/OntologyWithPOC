...
import (
	...
	"OntologyWithPOC/vm/wasmvm/disasm"
	"OntologyWithPOC/vm/wasmvm/exec/internal/compile"
	"OntologyWithPOC/vm/wasmvm/memory"
	"OntologyWithPOC/vm/wasmvm/wasm"
	ops "OntologyWithPOC/vm/wasmvm/wasm/operators"
)
